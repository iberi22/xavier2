...
| SH-05 | single_hop | What is Xavier2's current version? | 0ms | 0/5 | 0% | 0% | âŒ |
...
| MH-01 | multi_hop | Who worked on Xavier2 fixes and what decisions w... | 0ms | 0/5 | 0% | 0% | âŒ |
...
| MH-06 | multi_hop | What is the Xavier2 memory architecture? | 0ms | 0/5 | 0% | 0% | âŒ |
...
| TR-03 | temporal | What happened in the last session about Xavier2? | 0ms | 0/5 | 0% | 0% | âŒ |
| TR-04 | temporal | What is the timeline of Xavier2 versions? | 0ms | 0/5 | 0% | 0% | âŒ |
| OD-01 | open_domain | Summarize the Xavier2 memory system improvements... | 0ms | 0/5 | 0% | 0% | âŒ |
...
- **SH-05**: What is Xavier2's current version? (Precision: 0/5)
...
- **MH-01**: Who worked on Xavier2 fixes and what decisions were made? (Precision: 0/5)
...
- **MH-06**: What is the Xavier2 memory architecture? (Precision: 0/5)
- **TR-01**: When was pplx-embed fixed? (Precision: 0/5)
- **TR-02**: What decisions were made about SurrealDB persistence? (Precision: 0/5)
- **TR-03**: What happened in the last session about Xavier2? (Precision: 0/5)
- **TR-04**: What is the timeline of Xavier2 versions? (Precision: 0/5)
- **OD-01**: Summarize the Xavier2 memory system improvements made (Precision: 0/5)
...
- **SH-05**: What is Xavier2's current version? (Recall: 0%)
...
- **MH-01**: Who worked on Xavier2 fixes and what decisions were made? (Recall: 0%)
...
- **MH-06**: What is the Xavier2 memory architecture? (Recall: 0%)
- **TR-01**: When was pplx-embed fixed? (Recall: 0%)
- **TR-02**: What decisions were made about SurrealDB persistence? (Recall: 0%)
- **TR-03**: What happened in the last session about Xavier2? (Recall: 0%)
- **TR-04**: What is the timeline of Xavier2 versions? (Recall: 0%)
- **OD-01**: Summarize the Xavier2 memory system improvements made (Recall: 0%)
