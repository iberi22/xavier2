---
title: "GitCore + Xavier2 Integration Specification"
type: SPEC
id: "spec-gitcore-xavier2-integration"
created: 2026-03-17
updated: 2026-03-17
agent: codex
model: gpt-5
requested_by: user
summary: |
  Canonical integration contract for using Xavier2 as the shared memory backend
  across Git-Core agent workflows and IDE MCP configurations.
keywords: [gitcore, xavier2, mcp, memory, agents]
tags: ["#gitcore", "#xavier2", "#mcp", "#memory"]
project: xavier2
module: integration
language: rust
priority: high
...
# GitCore + Xavier2 Integration

## Purpose

Use Xavier2 as the shared memory backend for agents while keeping GitHub Issues as the only task-tracking substrate.
...
- Xavier2 stores reusable memory, research context, architecture recall, and long-horizon agent context.
...
Xavier2 implements a decentralized synchronization protocol inspired by Engram:
...
The current Xavier2 MCP/server documentation should match the existing implementation surface:
