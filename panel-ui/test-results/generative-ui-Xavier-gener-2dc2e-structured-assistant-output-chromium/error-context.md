...
- generic [ref=e3]:
  ...
  - main [ref=e15]:
    - generic [ref=e16]:
      - generic [ref=e17]:
        - paragraph [ref=e18]: Protected endpoint
        - heading "New Thread" [level=1] [ref=e19]
      - generic [ref=e20]:
        - generic [ref=e21]:
          - text: Threads
          - strong [ref=e22]: "0"
        - generic [ref=e23]:
          ...
          - strong [ref=e24]: "0"
    - generic [ref=e26]:
      - textbox "Ask Xavier for memory, code, or a structured answer..." [ref=e27]: Explain xavier memory and show the answer as a structured UI.
      - button "Send" [active] [ref=e28] [cursor=pointer]
```
